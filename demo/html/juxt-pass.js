// Copied from @juxt/pass dist/juxt-pass.esm.js while debugging.
...
function exchangeCodeForAccessToken({
  ...
  if (storedState !== queryParamState) {
    throw new Error(`exchangeCodeForAccessToken mismatch between stored state ${storedState} AND query param state ${queryParamState}`);
  }
