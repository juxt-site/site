...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13009 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13009(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13011 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13011(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13014 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13014(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13017 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13017(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13019 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13019(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13026 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13026(reader);
}
});
...
var G__13056 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13057 = s.append(c);
c = G__13056;
s = G__13057;
continue;
}
