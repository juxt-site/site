...
var i_16037 = (self__.level + (1));
while(true){
if((i_16037 <= (new_level + (1)))){
(update[i_16037] = self__.header);

var G__16038 = (i_16037 + (1));
i_16037 = G__16038;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_16039 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16039[i]));
} else {
x__$2.forward.push((((i < links_16039.length))?(links_16039[i]):null));
}

if((i < links_16039.length)){
(links_16039[i] = x__$2);
} else {
links_16039.push(x__$2);
}
...
var i_16041 = (0);
while(true){
if((i_16041 <= self__.level)){
var links_16042 = (update[i_16041]).forward;
if((x__$1 === (((i_16041 < links_16042.length))?(links_16042[i_16041]):null))){
(links_16042[i_16041] = (x__$1.forward[i_16041]));

var G__16043 = (i_16041 + (1));
i_16041 = G__16043;
continue;
} else {
var G__16044 = (i_16041 + (1));
i_16041 = G__16044;
continue;
}
} else {
...
var G__16046 = nx;
var G__16047 = (level__$1 - (1));
x = G__16046;
level__$1 = G__16047;
continue;
} else {
var G__16048 = x;
var G__16049 = (level__$1 - (1));
x = G__16048;
level__$1 = G__16049;
continue;
}
